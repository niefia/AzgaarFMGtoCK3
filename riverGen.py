...
#print("River Scaling factor used is: " + str(scaling_factor))
...
def generate_river_files(output_dir,scale_factor, min_x, max_x, min_y, max_y, x_offset, y_offset):
    """ this is the main function for riverGen.py"""
    # "Main"
    global scaling_factor, minx, maxx, miny, maxy, xoffset, yoffset
    ...
    path = os.path.join(output_dir, "map_data/")

    paint_land_sea(path + "heightmap.png", path + "landsea.png")
    draw_rivers(path + "landsea.png", path + "rivers.geojson", path + "rivermap.png",output_dir)
...
def draw_rivers(landsea_image, rivers_geojson, output_file,output_dir):
